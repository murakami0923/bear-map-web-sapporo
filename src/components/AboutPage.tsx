      ...
      <div className="about-card">
        ...
        <table className="about-table" aria-label="更新履歴">
          ...
          <tbody>
            <tr>
              <td>2026/08/02</td>
              <td>札幌市のヒグマ出没情報のサイトから、2026年7月30日 05:30までの出没データを追加。また、詳細モーダルの外をクリックしたらモーダルを閉じるよう修正。</td>
            </tr>
            <tr>
              <td>2026/06/07</td>
              <td>札幌市のヒグマ出没情報のサイトから、2026年6月5日 10:00までの出没データを追加。</td>
            </tr>
            <tr>
              <td>2026/05/24</td>
              <td>札幌市のヒグマ出没情報のサイトから、2026年5月24日時点の出没情報のデータを追加。また、「カメラでヒグマを確認」のデータがカメラアイコンで表示されるよう修正。</td>
            </tr>
            <tr>
              <td>2026/03/27</td>
              <td>札幌市のヒグマ出没情報のサイトから、2025年12月の出没情報と2026年3月26日の出没情報のデータを追加。また、フィルタで2026年を選択できるように修正。</td>
            </tr>
            <tr>
              <td>2026/02/23</td>
