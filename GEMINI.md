...
このプロジェクトは、北海道札幌市の**熊出没情報（2017〜2026年）**を MapLibre GL JS を使用して可視化する React + TypeScript アプリケーションです。
...
- **データバリデーション**:
  - `data/bears.geojson` は `Point` 座標、`year` (2017-2026)、`month` (1-12) を必須とする。
