...
北海道札幌市の **熊出没情報（2017〜2026）** を GeoJSON から読み込み、OpenStreetMap タイル上にプロットする Web アプリです。  
...
- 左上の **フィルタボタン（`icon/filter.svg`）** から年（2017〜2026）/月（1〜12）/アイコンを AND 条件で絞り込み  
...
- `year`: 2017〜2026 / `month`: 1〜12 を満たさない Feature は除外
...
- 2026/12/06: 12月5日に公開された熊出没情報を反映
- 2026/11/23: サイトを公開
